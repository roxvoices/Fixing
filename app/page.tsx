...
import { ALL_PROBLEMS, CATEGORIES } from '@/lib/allProblems'

export default function HomePage() {
  const popularFixes = ALL_PROBLEMS.filter((p) => p.isPopular)
  const recentFixes = [...ALL_PROBLEMS]
        ...
        <div className="pt-24 pb-12 px-4">
          ...
          <section className="max-w-7xl mx-auto text-center mb-20">
            <div>
              ...
              <p className="text-lg text-slate-600 max-w-2xl mx-auto mb-6">
                Step-by-step solutions for common tech problems. No expensive tools required,
                ...
                <Link key={cat.id} href={`/category/${cat.slug}`}>
                  <Card className="hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border-slate-200 group overflow-hidden h-full">
                    <CardContent className="p-4 md:p-6 flex flex-col items-center text-center">
                      ...
                      <h3 className="font-bold text-slate-900 text-sm md:text-base">{cat.name}</h3>
          ...
          <section className="max-w-7xl mx-auto mb-20 px-2 md:px-0">
            <div className="flex items-center justify-between mb-6 md:mb-8">
              <h2 className="text-xl md:text-2xl font-bold text-slate-900">Popular Fixes</h2>
          ...
          <section className="max-w-7xl mx-auto mb-20 px-2 md:px-0">
            <div className="flex items-center justify-between mb-6 md:mb-8">
              <h2 className="text-xl md:text-2xl font-bold text-slate-900">Recent Fixes</h2>
            </div>
            ...
            <div className="bg-slate-900 rounded-[2.5rem] p-8 md:p-16 text-center relative overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
                  Our database is growing every day. If you have a device issue that
                  isn&apos;t listed, let us know and our experts will create a guide for you.
                </p>
