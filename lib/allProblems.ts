...
// Merges ALL problem arrays from every data file into one.
// Used by generateStaticParams() so every slug gets a real HTML page.

import { INITIAL_PROBLEMS, CATEGORIES } from "./data"
